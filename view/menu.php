...
<div class="sidenav unselect">
  <div class="text-center" id="brand">SATNET</div>
  ...
  <a href="?<?= $m_user ?>/monitoring" class="sidenav_item <?= $monitoring_ma ?>"><i class="fa fa-send"></i> Monitoring</a>
...
<div class="navbar" id="mnav">
  ...
  <a href="?<?= $m_user ?>/monitoring" class="<?= $monitoring_ma ?>"><i class="fa fa-send"></i> Monitoring</a>
